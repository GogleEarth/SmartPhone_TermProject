...
class PlayDetailTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "segueToMapView"
        {
            ...
            {
                mapViewController.xpos = (REFINE_WGS84_LOGT as! NSMutableString as NSString).floatValue
                mapViewController.ypos = (REFINE_WGS84_LAT as! NSMutableString as NSString).floatValue
            }
        }
    }
